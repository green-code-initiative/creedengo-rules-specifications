...
- https://rweb.greenit.fr/en/fiches/RWEB_0017-avoid-transferring-large-amounts-of-data-for-processing-tasks[Best practices guidelines for web ecodesign (RWEB)] - Avoid transferring large amounts of data for processing tasks
