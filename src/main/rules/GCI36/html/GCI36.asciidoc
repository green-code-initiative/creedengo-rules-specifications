...
[source,html,data-diff-id="2",data-diff-type="compliant"]
----
<video src="videofile.webm" preload="none"></video>
...
- https://rweb.greenit.fr/en/fiches/RWEB_0106-avoid-autoplay-for-videos-and-audio-content[Best practices guidelines for web ecodesign (RWEB)] - Avoid autoplay for videos and audio content

=== Articles & blog posts

- https://www.ecoindex.fr/en/ecodesign/[Ecodesign and good practices]