...
For simple, testable conditions (e.g., checking if a file exists), logical checks (like `file_exists`) are more efficient and avoid the performance cost of exception handling.
