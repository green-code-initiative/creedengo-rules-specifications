...
image::1GB.etsdiff.png[ETSdiff percent comparison" style="padding: 1rem;]
...
image::2GB.etsdiff.png[ETSdiff percent comparison" style="padding: 1rem;]
...
image::4GB.etsdiff.png[ETSdiff percent comparison" style="padding: 1rem;]
...
image::8GB.etsdiff.png[ETSdiff percent comparison" style="padding: 1rem;]
