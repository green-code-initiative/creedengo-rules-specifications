...
- https://rweb.greenit.fr/en/fiches/RWEB_0009-avoid-javascriptcss-animations[Best practices guidelines for web ecodesign (RWEB)] - Avoid JavaScript / CSS animations
