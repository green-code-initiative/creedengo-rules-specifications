...
- https://rweb.greenit.fr/en/fiches/RWEB_0040-update-several-css-properties-at-once[Best practices guidelines for web ecodesign (RWEB)] - Update several CSS properties at once
