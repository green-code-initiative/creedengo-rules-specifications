...
**Conclusion**: the rule is clearly relevant for collections on the order of a hundred
elements and above; the gain is marginal at ten.
...
both variants at once. Worth keeping in mind when reading the plots.
...
- Consolidated data: `level2-energytracer/campaign1/consolidated-report/data/` — 5,400 measurements (3 sizes × 2 variants × 900)
- Plots: `level2-energytracer/campaign1/consolidated-report/plots/`
- Raw EnergyTracer reports: `level2-energytracer/campaign1/consolidated-report/reports-source/`
...
See also `level2-energytracer/campaign2/campaign2-interpretation.md` for the follow-up
campaign, which adds three intermediate sizes (30, 50, 500) and refines this document's
conclusions on the scaling law and the relevance threshold.
