...
Getters and setters add unnecessary overhead due to method call stack and memory usage.
Direct attribute access is more efficient when no additional logic is required.
...
=== Documentation
- https://docs.python.org/3/tutorial/classes.html[Python Documentation - Classes]

=== Articles & blog posts
- https://www.datacamp.com/tutorial/property-getters-setters[Datacamp - Python @property, Getters, and Setters]
