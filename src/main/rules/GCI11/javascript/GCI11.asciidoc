...
- https://rweb.greenit.fr/en/fiches/RWEB_0057-reduce-dom-access-via-javascript[Best practices guidelines for web ecodesign (RWEB)] - Reduce DOM access via JavaScript
