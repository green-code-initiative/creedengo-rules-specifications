...
[#414](https://github.com/green-code-initiative/creedengo-rules-specifications/pull/414) : Hibernate queries must be paginated to avoid excessive data loading
