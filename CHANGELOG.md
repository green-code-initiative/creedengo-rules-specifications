...
- Added rule GCI1066: For logging format, prefer using kwargs instead of builtin formatter, that way message formatting will be deferred until it cannot be avoided.
